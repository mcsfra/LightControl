...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic18f45k22.h"
...
typedef unsigned char BUTTONNUMBER;

typedef unsigned char ASSIGNEDSCENE;
...
extern void initButton(BUTTONINDEX i, BUTTONNUMBER bn, ASSIGNEDSCENE as ) ;

extern void triggerScene(BUTTON *bp);
extern void enterContinuousMode(BUTTON *bp);

extern void initAllButtons(void);

extern void testRC2Errors(void);

extern void registerButton(unsigned char button, unsigned char action);
extern unsigned char getAssignedScene(unsigned char buttonCode);

# 56
extern void initFlashButtonMatrix(void);
void storeAButton(unsigned char button, unsigned char program);
unsigned char readAButton(unsigned char button);
...
void doDimStart(unsigned char program);

void doDimStep(void);
void doDimStepText(void);

extern void switchSceneOff(unsigned char scene);
extern void switchSceneOn(unsigned char scene);
extern void continuousDim(unsigned char scene);

unsigned char getChannelValue(unsigned char channel);
...
extern void storeCurrentScene(unsigned char scene);
...
# 11 "protocol.h"
extern void initButtonProtocol(void);
extern void buttonByteReceived(unsigned char b);
...
unsigned char buttonProgram;

unsigned char i;

for ( i = 0; i < 0xFF; i++) {
buttonProgram = readAButton(i );

if ( buttonProgram != 0) {
initButton(buttonIndex, i, buttonProgram);
buttonIndex++;
}
}
}
...
# 145
void initButton(BUTTONINDEX i, BUTTONNUMBER bn, ASSIGNEDSCENE as) {
...
TRISAbits.TRISA0 = 0;
PORTAbits.RA0 = PORTAbits.RA0 == 1 ? 0 : 1;

if (bp -> buttonMode == 0) {
triggerScene(bp);
}
else {
enterContinuousMode(bp);
}
}

# 196
void triggerScene(BUTTON *bp) {
...
doDimStart(bp -> assignedScene);
}

# 211
void enterContinuousMode(BUTTON *bp) {
...
if (bp -> isOn) {
switchSceneOff(bp -> assignedScene);
bp -> isOn = 0;
}
else {
switchSceneOn(bp -> assignedScene);
bp -> isOn = 1;
}
}
else {
if (bp -> isOn) {
continuousDim(bp -> assignedScene); }
}
...
unsigned char getAssignedScene(unsigned char buttonCode) {

BUTTON *bp = findButton((BUTTONNUMBER)buttonCode);

if (bp == 0)
return 0;

return bp -> assignedScene;
}
...
# 279
void registerButton(unsigned char button, unsigned char action) {

storeAButton(button, action );
initAllButtons();

}

# 298
void initFlashButtonMatrix() {
...
storeAButton( 0x20, 0x0A );
storeAButton( 0x21, 0x0B );
storeAButton( 0x22, 0x0C );
storeAButton( 0x23, 0x0D );
storeAButton( 0x24, 0x0E );
storeAButton( 0x25, 0x0F );
storeAButton( 0x26, 0x10 );
storeAButton( 0x27, 0x30 );

storeAButton( 0x30, 0x01 );
storeAButton( 0x31, 0x02 );
storeAButton( 0x32, 0x03 );
storeAButton( 0x33, 0x04 );
storeAButton( 0x34, 0x01 );
storeAButton( 0x35, 0x02 );
storeAButton( 0x36, 0x03 );
storeAButton( 0x37, 0x04 );
storeAButton( 0x38, 0x02 );
storeAButton( 0x39, 0x02 );
storeAButton( 0x3A, 0x03 );
storeAButton( 0x3B, 0x04 );
storeAButton( 0x3C, 0x01 );


storeAButton( 0x40, 0x01 );
storeAButton( 0x41, 0x02 );
storeAButton( 0x42, 0x03 );
storeAButton( 0x43, 0x04 );
storeAButton( 0x44, 0x01 );
storeAButton( 0x45, 0x02 );
storeAButton( 0x46, 0x03 );
storeAButton( 0x47, 0x04 );
storeAButton( 0x48, 0x01 );
storeAButton( 0x49, 0x02 );
storeAButton( 0x4A, 0x03 );
storeAButton( 0x4B, 0x04 );
...
HDByteReadI2C( 0xA0,0, button, &program, 1 );
return program;
}

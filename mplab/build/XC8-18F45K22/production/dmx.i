...
# 12 "dmx.c"
extern CHANNEL channels[128U];



extern unsigned char debugLevels[64];
extern unsigned char debugCounter;

extern unsigned char testLevel;

extern unsigned char dbuf[32];
extern unsigned char sbuf[32];
...
TX1REG = dataCounter++ < 128U ? channels[(unsigned char)dataCounter].s.level : 0;
...
channels[channel].s.level = level;


if ( bufCount < 32) {
dbuf[bufCount] = channel;
sbuf[bufCount] = level;
bufCount++;
}

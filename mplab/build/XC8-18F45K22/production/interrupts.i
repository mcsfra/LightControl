...
extern void sendDMX(void);
extern void initDMXSend(void);
...
# 10 "interrupts.c"
extern volatile unsigned char bDoDimStep;
extern volatile unsigned char bButtonReset;
extern volatile unsigned char bSPISlave;

extern volatile unsigned char bI2CReadPending;

volatile unsigned char data;


unsigned char requestedData[32];
unsigned char rdp = 0;
...
# 85
if ( SSP2STATbits.RW2 == 0 && SSP2STATbits.DA2 == 0 && SSP2STATbits.BF == 1) {
data = SSP2BUF;
}

# 102
else if ( SSP2STATbits.RW2 == 0 && SSP2STATbits.DA2 == 1 && SSP2STATbits.BF == 1 ) {
data = SSP2BUF;
fifo2Put(data);
}

# 118
else if ( SSP2STATbits.RW2 == 1 && SSP2STATbits.DA2 == 0 ) {
...
# 169
else if ( SSP2STATbits.RW2 == 1 && SSP2STATbits.DA2 == 1 && SSP2STATbits.BF == 0 ) {

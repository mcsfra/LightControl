...
extern void i2cWrite(unsigned char dat);
...
void writeTestPattern(unsigned char bank) {

unsigned char i;

for ( i = 0; i < 0xFF; i++ ) {
HDByteWriteI2C(0xA0, bank, i,i);
}
}

void readTestPattern(unsigned char bank) {

unsigned char r[32];

HDByteReadI2C( 0xA0,bank, 0, r, 32 );
HDByteReadI2C( 0xA0,bank, 0, r, 32 );

...
ifeq "$(wildcard nbproject/Makefile-local-XC8_18F14K50.mk)" "nbproject/Makefile-local-XC8_18F14K50.mk"
include nbproject/Makefile-local-XC8_18F14K50.mk
endif
endif
...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c interrupts.c main.c system.c hardware.c dmx.c buttons.c fifo.c scenes.c massStorage.c protocol.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/hardware.p1 ${OBJECTDIR}/dmx.p1 ${OBJECTDIR}/buttons.p1 ${OBJECTDIR}/fifo.p1 ${OBJECTDIR}/scenes.p1 ${OBJECTDIR}/massStorage.p1 ${OBJECTDIR}/protocol.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/hardware.p1.d ${OBJECTDIR}/dmx.p1.d ${OBJECTDIR}/buttons.p1.d ${OBJECTDIR}/fifo.p1.d ${OBJECTDIR}/scenes.p1.d ${OBJECTDIR}/massStorage.p1.d ${OBJECTDIR}/protocol.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/hardware.p1 ${OBJECTDIR}/dmx.p1 ${OBJECTDIR}/buttons.p1 ${OBJECTDIR}/fifo.p1 ${OBJECTDIR}/scenes.p1 ${OBJECTDIR}/massStorage.p1 ${OBJECTDIR}/protocol.p1

# Source Files
SOURCEFILES=configuration_bits.c interrupts.c main.c system.c hardware.c dmx.c buttons.c fifo.c scenes.c massStorage.c protocol.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-XC8_18F14K50.mk dist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/LightController.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/XC8_18F14K50
	${RM} -r dist/XC8_18F14K50
